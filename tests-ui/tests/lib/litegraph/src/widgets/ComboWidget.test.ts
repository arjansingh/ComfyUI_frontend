...
describe('ComboWidget', () => {
  ...
  describe('canIncrement / canDecrement', () => {
    ...
    it('should return false when at first value (canDecrement)', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'fast',
    ...
    it('should return false when at last value (canIncrement)', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'slow',
    ...
    it('should handle edge case where first and last values are the same', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'duplicate',
    ...
    it('should return false for function values (legacy duck-typed)', () => {
  ...
  describe('incrementValue / decrementValue', () => {
    it('should increment value to next in list', () => {
      ...
      const mockCanvas = { ds: { scale: 1 }, last_mouseclick: 1 } as any
    ...
    it('should handle object values with index-based setValue', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'quality',
          value: 'hq',
  ...
  describe('onClick', () => {
    it('should call decrementValue when clicking left arrow area', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'medium',
      ...
      const mockCanvas = { ds: { scale: 1 }, last_mouseclick: 0 } as any
      const mockEvent = { canvasX: 60 } as any // 60 - 50 = 10 < 40 (left arrow)
      node.pos = [50, 50]
    ...
    it('should call incrementValue when clicking right arrow area', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'medium',
      ...
      const mockCanvas = { ds: { scale: 1 }, last_mouseclick: 0 } as any
      const mockEvent = { canvasX: 240 } as any
      node.pos = [50, 50]
      node.size = [200, 30]
    ...
    it('should show dropdown menu when clicking center area with array values', () => {
      ...
      const mockEvent = { canvasX: 150 } as any
      node.pos = [50, 50]
      node.size = [200, 30]
    ...
    it('should set index when selecting from dropdown with object values', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'quality',
          value: 'hq',
    ...
    it('should prevent menu scaling below 100%', () => {
      ...
      const mockCanvas = { ds: { scale: 0.5 } } as any
      const mockEvent = { canvasX: 150 } as any
      node.pos = [50, 50]
      node.size = [200, 30]
  ...
  describe('with getOptionLabel', () => {
    ...
    describe('_displayValue', () => {
      ...
      it('should work with non-hash filenames', () => {
      ...
      it('should take precedence over object values mapping', () => {
      ...
      it('should convert number values to string before passing to getOptionLabel', () => {
    ...
    describe('onClick', () => {
      ...
      it('should handle duplicate display labels correctly using addItem API', () => {
        const mockGetOptionLabel = vi
          .fn()
        ...
        const mockContextMenu = vi.fn((_values, options) => {
          capturedCallback = options.callback
          return { addItem: mockAddItem } as any
        })
        LiteGraph.ContextMenu = mockContextMenu as any
  ...
  describe('edge cases', () => {
    ...
    it('should handle value not in values list', () => {
      widget = new ComboWidget(
        createMockWidgetConfig({
          name: 'mode',
          value: 'nonexistent',
